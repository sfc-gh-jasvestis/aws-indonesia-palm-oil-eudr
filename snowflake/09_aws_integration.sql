-- ============================================================================
-- 09_AWS_INTEGRATION.SQL — AWS services for EUDR Compliance Engine
...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION aws_indonesia_palm_oil_eudr_BEDROCK_EAI
  ALLOWED_NETWORK_RULES = (PALM_OIL_EUDR.APP.BEDROCK_NETWORK_RULE)
  ALLOWED_AUTHENTICATION_SECRETS = (PALM_OIL_EUDR.APP.AWS_BEDROCK_SECRET)
  ENABLED = TRUE
  COMMENT = 'Bedrock access for EUDR Compliance Engine';
...
CREATE OR REPLACE FUNCTION APP.BEDROCK_GENERATE(prompt VARCHAR)
  ...
  EXTERNAL_ACCESS_INTEGRATIONS = (aws_indonesia_palm_oil_eudr_BEDROCK_EAI)
  SECRETS = ('aws_creds' = PALM_OIL_EUDR.APP.AWS_BEDROCK_SECRET)
AS $$
...
CREATE OR REPLACE STORAGE INTEGRATION aws_indonesia_palm_oil_eudr_S3_INT
  TYPE = EXTERNAL_STAGE
  STORAGE_PROVIDER = 'S3'
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::018437500440:role/snowflake-sea-demos-s3'
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://sea-aws-demos-018437500440/aws-indonesia-palm-oil-eudr/');

-- External stage for data landing
CREATE OR REPLACE STAGE RAW.LANDING_STAGE
  STORAGE_INTEGRATION = aws_indonesia_palm_oil_eudr_S3_INT
  URL = 's3://sea-aws-demos-018437500440/aws-indonesia-palm-oil-eudr/';
